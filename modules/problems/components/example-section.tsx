    ...
    <div>
      ...
      <div className="bg-muted p-4 rounded-lg space-y-2">
        <div>
          ...
          <code
            className="text-sm dark:bg-zinc-900 bg-zinc-200 text-zinc-900
           dark:text-zinc-200 px-2 py-1 rounded"
          >
            {example.input}
          </code>
        </div>
        <div>
          ...
          <code
            className="text-sm dark:bg-zinc-900 bg-zinc-200
           text-zinc-900 dark:text-zinc-200 px-2 py-1 rounded"
          >
            {example.output}
          </code>
        </div>
